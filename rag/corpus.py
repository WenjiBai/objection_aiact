...
SEED_CHUNKS: list[Reference] = [
    ...
    # ============================================================
    # AI Act expansion (RAG-5) — verbatim from EUR-Lex CELEX:32024R1689
    # 25 priority Articles, 3 whole Annexes, 4 Annex III items, 8 Recitals
    # + 3 Finnish (Traficom) context chunks. Generated 2026-05-23.
    # ============================================================
    ...
    Reference(
        code='R-Annex-II',
        article_no='Annex-II',
        title='Annex II — List of criminal offences referred to in Article\xa05(1), first subparagraph, point (h)(iii)',
    ...
    Reference(
        code='R-Annex-IV',
        article_no='Annex-IV',
        title='Annex IV — Technical documentation referred to in Article\xa011(1)',
    ...
    Reference(
        ...
        title='Annex VIII — Information to be submitted upon the registration of high-risk AI systems in accordance with Article\xa049',
